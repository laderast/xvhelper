...
There is now the ability to run Table Exporter if your `extract_data()` query fails. [See the article](https://laderast.github.io/xvhelper/articles/Running-Table-Exporter.html)
